...
const BattleHeader = () => {
  ...
  const hadleEndTurnClick = () => {
    ...
    const temporarySpells = findTempSpellsOnField(fieldCells, newPlayer);
    const turnSpells = findTurnSpellsOnField(fieldCells, thisPlayer);
    const activeWarCard = findActiveWarCard(fieldCells, thisPlayer);
