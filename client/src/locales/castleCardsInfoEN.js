export default {
  ...
  ThunderBlast: 'Attack warrior with spell power 3 or 4 if this is postponed card, additionally stun all warriors in the adjacent cells',
  Swift: 'Attach to an warrior. This warrior can attack and move in the same turn',
  Resurrection: 'Take a warrior card from your stock and play it for free. Can\'t be postponed card',
  Retribution: 'A warrior gets +1 to attack power on his turn, and +1 to attack power for every positive effect on your warriors or on the battlefield',
  AttackAura: 'Attach to an warrior. Attacks a random enemy standing in the same row with this warrior with a power of 2 when played and as LAST CAST',
  ...
  Enlightenment: 'Placed next to the field, all your warriors get +1 to attack power on their turn',
  ...
  Bless: 'Attach to an warrior, this warrior gets + 1 attack power',
  ...
  HeavenShock: 'Attack warrior on the field with power 2 and cure 2 health from your hero',
  SaintWord: 'Attack with power 2 or power 3, if this card is postponed, all enemy warriors in the line, as well as with power 2 enemy warriors in a random neighboring line',
  ...
  LightShield: 'Attach to an warrior. This warrior gets +2 to health',
