...
export const menuTipsText = {
  ...
  EVASION: 'Warrior absorbs attack from enemy warrior but become stunned and has to move on the next free cell without retaliation (can\'t be used if there are no free cell or he is already stunned)',
