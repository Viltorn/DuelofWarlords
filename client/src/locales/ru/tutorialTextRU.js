...
export default {
  ...
  step13: 'После совершения атаки или передвижения воины становятся неактивными не могут атаковать или передвигаться в этом ходу. Теперь нажмите "Продолжить", чтобы посмотреть ход врага',
