...
export default {
  translation: {
    mainPage: {
      ...
      PostponedDescription: 'В игре большую роль играет не только ваша колода, но и то как вы ее разыграете: неожиданные комбинации, заманивание противника в ловушки - от этого зависит успех сражения!',
