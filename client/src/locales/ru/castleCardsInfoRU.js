export default {
  ...
  RetributionSword: 'АРТЕФАКТ. Вместо хода героя: воин получает +Х к единоразовой атаке. Х - количество положительных заклинаний на союзных воинах или на поле боя',
};
