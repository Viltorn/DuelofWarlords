export default {
  ...
  Resistance: 'Накладывается на воина, он получает МАГИЧЕСКИЙ ЩИТ',
  ...
  BattleTactics: 'Кладется рядом с вашей линией. Можно переместить каждого воина в этой линии на свободную клетку',
