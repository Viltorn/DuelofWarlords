export default {
  ...
  step1: 'If you play as player 1, your troops and the warlord are located on the left half of the battlefield, if you play as player 2, then on the right side',
  ...
  step15: 'After both players end their turns, the next round begins and the players receive the number of action points equal to the number of the current round (regardless of whether they still have points left or not from the previous round)',
  step16: 'So, the "Imperial Shooter" card came to your hand, it costs 1, that is displayed in a black square on the card. "Imperial Shooter" belongs to the class of Shooter as it has a "target" icon in the upper left corner of the card',
  ...
  step18: 'Warriors enter the game in inactive state, so you will not be able to use them immediately. You don\'t have any action points left, so click the red "end turn" button on the header bar to start the next round',
  ...
  step25: 'As all warriors are on the field, let\'s try to make an attack with your shooter: shooters can attack any warrior in the row, while they do not receive a retaliatory strike, but they either cannot retaliate to enemies',
  ...
  step36: 'A temporary spell card has come to you - it has a sandglass icon in the upper left corner, such cards are valid for one turn and are sent to the grave in the beginning of your next turn',
  step37: 'The spell "Holy Land" attacks all enemies who step into the row in which it is located. Let\'s play her in a row with a Griffon to prevent the enemy from defending their warlord',
  ...
  step41: 'The "Light shield" spell card has come into your hand - this is a permanent card, because it has a "two arrows" sign in the upper left corner, such a card is attached usually to a warrior (but not necessarily) and will act until this warrior leaves the battlefield',
  step42: 'In any case, only 2 spells can be attached to one warrior at a time. Select the "Light shield" and apply it to your "Warrior of Light", which was damaged earlier, to add 2 health to it',
  ...
  step48: 'To make a card postponed, you put it in a special cell face down and immediately pay the price of the card, but you can only play it on your next turn',
  step49: 'Select the "Thunder blast" and make this card postponed',
  step50: 'Now click "end turn"',
  step51: 'In the new round, you can play your postponed card with an enhanced effect, but the "Thunder blast" not only attack the target warrior, but also stuns the warriors in adjacent cells. Adjacent cells are all the cells around the target, except the cells diagonally (including enemy cells)',
  step52: 'Try to cast a spell by selecting it and attacking an enemy Golem - you will see how your "Thunder blast" will work',
  step53: 'Try to cast a spell by selecting it and attacking an enemy Golem - you will see how your "Thunder blast" will work',
  step54: 'Try to cast a spell by selecting it and attacking an enemy Golem - you will see how your "Thunder blast" will work',
  ...
  step57: 'If the event does not occur, the card will return to your hand at the end of your next turn, but since the card will be lying face up, it will be revealed to your enemy',
  step58: 'Select the "Last chance" and make the card postponed',
  step59: 'Great! Time to end this turn and see if your spell works',
  step60: 'The opponent\'s "Magician\'s Apprentice" attacked your "Imperial Shooter", but could not kill him, as the "Last chance" spell worked. After the spell is used, it immediately went to the grave',
