...
const academiaDeck = [
  {
    name: 'Living wall', type: 'warrior', subtype: 'fighter', power: 2, currentP: 2, health: 5, currentHP: 5, cost: 2, description: 'БОЕЦ. Не может передвигаться и атаковать в свой ход', id: _.uniqueId(), features: {}, attachments: [], img: LivingWall, status: 'hand', turn: 1,
  },
  {
  ...
  {
    name: 'Rakshasa', type: 'warrior', subtype: 'fighter', power: 2, currentP: 3, health: 6, currentHP: 6, cost: 3, description: 'Имеет УВОРОТ.', id: _.uniqueId(), features: {}, attachments: [], img: Rakshasa, status: 'hand', turn: 1,
  },
  {
    name: 'Rakshasa', type: 'warrior', subtype: 'fighter', power: 2, currentP: 3, health: 6, currentHP: 6, cost: 3, description: 'Имеет УВОРОТ.', id: _.uniqueId(), features: {}, attachments: [], img: Rakshasa, status: 'hand', turn: 1,
  },
  ...
  },
  {
    ...
    id: _.uniqueId(),
    features: [{
      place: 'postponed', aim: ['field', 'warrior', 'hero'], type: 'good', name: 'protection', value: 100, charges: 1, condition: 'attackingPower', conditionValue: 3,
    }],
    img: ArcaneArmor,
    status: 'hand',
  },
  {
    ...
    features: [
      {
        place: 'midSpell', type: 'bad', aim: ['row'], value: 3,
      },
    ],
    img: Blizzard,
    status: 'hand',
  ...
  },
  {
    ...
    id: _.uniqueId(),
    features: [{
      place: '', type: 'bad', name: 'attack', value: 2, aim: ['warrior', 'line'],
    }],
    img: IceSpikes,
    status: 'hand',
  },
  ...
  },
  {
    ...
    id: _.uniqueId(),
    features: [{
      place: '', type: 'bad', name: 'attack', value: 200, aim: ['warrior'],
    }],
    img: SoulDrain,
    status: 'hand',
  },
  {
    ...
    id: _.uniqueId(),
    features: [{
      place: 'attach', type: 'good', aim: ['warrior'], name: 'moving',
    }],
    img: Teleport,
    status: 'hand',
  },
  {
    name: 'Town portal', type: 'spell', subtype: 'instant', cost: 3, description: 'Вражеский воин отправляется в руку к владельцу и восстанавливает здоровье (если на воине был эффект, то он возвращается в руку владельцу)', id: _.uniqueId(), features: [{ place: '', type: 'bad' }], img: TownPortal, status: 'hand',
  },
  {
    name: 'Transformation', type: 'spell', subtype: 'instant', cost: 1, description: 'Воин получает ОГЛУШЕНИЕ и вы можете передвинуть его на соседню клетку', id: _.uniqueId(), features: [{ place: '', type: 'bad' }], img: Transformation, status: 'hand',
  },
  {
    name: 'Tsunami', type: 'spell', subtype: 'instant', cost: 7, description: 'Отнять 7 здоровья у всех не летающих воинов на поле боя или 8, если это отложенная способность', id: _.uniqueId(), features: [{ place: '', type: 'bad' }], img: Tsunami, status: 'hand',
  },
  {
    name: 'Waterfall', type: 'spell', subtype: 'temporary', cost: 2, description: 'Кладется рядом с полем боя. Все воины с текущей базовой атакой 2 или меньше не могут атаковать в свой ход', id: _.uniqueId(), features: [{ place: 'bigSpell', aim: ['field'], value: 'currentPow === 2' }], img: Waterfall, status: 'hand',
  },
  {
    name: 'Ice arrow',
    type: 'spell',
    ...
    features: [{
      ...
      place: '', type: 'bad', aim: ['warrior'], name: 'stun',
    }],
    img: IceArrow,
    status: 'hand',
  },
  {
    ...
    subtype: 'temporary',
    cost: 1,
    description: 'Накладывается на союзного воина или героя. При получении урона во время хода врага, отнимается здоровье у Ледяной брони, пока оно не станет равным 0.',
    id: _.uniqueId(),
    features: [{
      place: 'attach',
      aim: ['field', 'hero'],
