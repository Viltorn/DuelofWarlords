...
export default {
  ...
  Conciliation: {
    ...
    place: 'bigSpell',
    features: [{
      spell: true, attach: ['field', 'warrior'], type: 'good', name: 'protection', token: 'protection', aim: ['warrior', 'spell', 'fighter', 'shooter', 'flyer'], value: { type: 'number', val: 100 }, aimStatus: 'field',
    }],
    img: Сonciliation,
    status: 'hand',
    disabled: false,
