...
const academiaDeck = {
  ...
  MageApprentice: {
    name: 'Mage apprentice', id: _.uniqueId(), type: 'warrior', subtype: 'shooter', power: 2, currentP: 2, health: 4, currentHP: 4, cost: 3, currentC: 3, featInfo: ['SHOOTER'], description: 'MageApprentice', faction: 'Academia', features: [{ name: 'protection', value: { type: 'percent', val: 0.5 }, aim: ['spell'] }], attachments: [], img: MageApprentice, status: 'hand', turn: 1,
  },
  GremlinShooter: {
